...
$(document).ready(function() {
	...
	function clearAll() {
		...
		$("#ageval").text(0);
		$('#age').slider('refresh');
		$('.selectpicker').selectpicker('val','Válassz..');
	...
	$('#btn_forward_1').click(function(){
		...
		if (_gender == '') {
			$('.dropdown.bootstrap-select').next('.valid-feedback').hide();
			$('.dropdown.bootstrap-select').next('.valid-feedback').next('.invalid-feedback').show();
			_valid_3 = false;
		}
		else {
			$('.dropdown.bootstrap-select').next('.valid-feedback').show();
			$('.dropdown.bootstrap-select').next('.valid-feedback').next('.invalid-feedback').hide();
			_valid_3 = true;
		}
